...
type SettingsTab = "credentials" | "pricing";
      ...
      >
        <div className="shrink-0 border-b border-zinc-800 px-5 py-4">
          ...
          <p className="mt-1 text-xs text-zinc-500">
            API keys are saved in your browser only (localStorage).
          </p>
          <div className="mt-3 flex gap-1 rounded-lg border border-zinc-800 bg-zinc-950 p-0.5">
            <TabButton
            ...
            <div className="space-y-5">
              ...
              <section>
                ...
                <p className="mt-1 text-xs text-zinc-500">
                  ...
                  deployed on Vercel, sandbox auth is automatic (OIDC).
                </p>
                {showVercel && (
              ...
              <section className="rounded-xl border border-zinc-800 bg-zinc-950/60 p-4">
                ...
                <ol className="mt-2 list-decimal space-y-1.5 pl-4 text-xs text-zinc-400">
                  ...
                  <li>Deploy — sandbox uses OIDC automatically</li>
                </ol>
              </section>
            </div>
          ) : (
